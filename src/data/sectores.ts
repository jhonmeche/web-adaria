...
export const sectores: Sector[] = [
  ...
  },
  {
    ...
    detalle: {
      ...
      intro:
        'Implementamos inspección visual automatizada, monitoreo de variables críticas, integración con PLCs y analítica para reducir defectos, paradas y pérdidas de productividad.',
      contexto:
